...
# ProductUpgrade Context Retriever
...
ls .productupgrade/DENSITY-CUMULATIVE.md 2>/dev/null
ls .productupgrade/REFLEXION-LOG.md 2>/dev/null
```
...
Write output to `.productupgrade/INTEL-CONTEXT.md`
