...
# ProductUpgrade Density Summarizer
...
- `.productupgrade/REVIEW-*.md`
- `.productupgrade/AUDIT-*.md`
- `.productupgrade/JUDGE-*.md`
- `.productupgrade/UPGRADE-LOG.md`
- `.productupgrade/REFLEXION-LOG.md` (if exists)
- `.productupgrade/THOUGHT-GRAPH.md` (if exists)
...
## Cumulative Summary
Also maintain `.productupgrade/DENSITY-CUMULATIVE.md` — a running summary across ALL iterations:
```markdown
