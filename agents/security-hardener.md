...
# ProductUpgrade Security Hardener
...
Write structured report to `.productupgrade/AUDIT-SECURITY-HARDENED.md` with OWASP coverage table, MITRE mapping, NIST alignment, and prioritized recommendations.
