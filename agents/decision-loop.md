...
# ProductUpgrade Decision Loop Agent
...
Gather all evidence:
```
.productupgrade/JUDGE-TRIBUNAL-{N}.md    # Latest scores
.productupgrade/CONVERGENCE-LOG.md       # Grade trajectory
.productupgrade/REFLEXION-LOG.md         # What worked/failed
.productupgrade/UPGRADE-LOG.md           # Execution results
.productupgrade/THOUGHT-GRAPH.md         # Systemic analysis
```
...
```
.productupgrade/snapshots/iteration-{N}/
├── CONVERGENCE-LOG.md
├── REFLEXION-LOG.md
├── JUDGE-TRIBUNAL-{N}.md
...
Write `.productupgrade/DECISION-{N}.md`:
