...
Monte Carlo Tree Search applied to LLM reasoning. Explores multiple solution paths with backtracking, evaluation, and reflection. The most powerful (and expensive) technique — use only in /ultra-upgrade mode.
...
## When to Use
- /ultra-upgrade mode ONLY (too expensive for basic mode)
